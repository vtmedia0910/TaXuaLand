...
export const SourceSchema = z
  .object({
    ...
    providerId: z.string().max(100).nullable(),
    category: z.enum(["PLACES", "TERRAIN", "IMAGERY", "ROADS", "OTHER"]),
    authorityLevel: SourceAuthority,
    licenseName: z.string().max(200).nullable(),
    licenseReference: SafeUrl.nullable(),
    commercialUse: PermissionStatus,
    publicDisplay: PermissionStatus,
    ...
    status: z.enum(["ACTIVE", "DISABLED", "REVIEW_REQUIRED"]),
